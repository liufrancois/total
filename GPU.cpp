...
void MetalOperations::total1(MTL::Buffer *naxesIn,
                            MTL::Buffer *cubeIn,
                            MTL::Buffer *result,
                            MTL::Buffer* bzeroIn,
                            size_t arrayLength
...
{
    std::vector<MTL::Buffer *> buffers = {naxesIn,
        cubeIn,
        result,
        bzeroIn};
    const char *method = "total1";
    Blocking1D(buffers, arrayLength, method);
}

void MetalOperations::total2(MTL::Buffer *naxesIn,
                            MTL::Buffer *cubeIn,
                            MTL::Buffer *result,
                            MTL::Buffer* bzeroIn,
                            size_t arrayLength
                        )
{
    std::vector<MTL::Buffer *> buffers = {naxesIn,
        ...
        result,
        bzeroIn};
    const char *method = "total2";
    Blocking1D(buffers, arrayLength, method);
}

void MetalOperations::total3(MTL::Buffer *naxesIn,
                            MTL::Buffer *cubeIn,
                            MTL::Buffer *result,
                            MTL::Buffer* bzeroIn,
                            size_t arrayLength
                        )
{
    std::vector<MTL::Buffer *> buffers = {naxesIn,
        ...
        result,
        bzeroIn};
    const char *method = "total3";
    Blocking1D(buffers, arrayLength, method);
}

void MetalOperations::total4(MTL::Buffer *naxesIn,
                            MTL::Buffer *cubeIn,
                            MTL::Buffer *result,
                            MTL::Buffer* bzeroIn,
                            size_t arrayLength
